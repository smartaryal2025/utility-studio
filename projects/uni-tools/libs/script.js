...
function unicodeToPreeti(text) {
    ...
    // The (^|[^्]) ensures that 'र्' is not aggressively extracted if it is part of a 
    // consonant cluster that naturally includes a halant (like त्र्य / क्ऱ्य).
...
clearBtn.addEventListener('click', () => {
    ...
    outputText.value = '';
    errorMsg.classList.add('hidden');
    inputText.focus(); // Brings the cursor back to the input box automatically
});
